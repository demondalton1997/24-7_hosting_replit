...
### Important note
This is a **strategy sandbox/simulation planner only**. It does **not** provide or include game hacking, injection, spoofing, cheating, or account tampering features.
